...
<div
  class="flex flex-col gap-5 w-1/5 absolute left-1/2 top-1/2 -translate-y-1/2 -translate-x-1/2 outline shadow-2xl p-10 text-black bg-white -outline-offset-8 break-all"
>
